from clients.exercises.exercises_schema import CreateExerciseRequestSchema, CreateExerciseResponseSchema, ExerciseSchema, GetExerciseResponseSchema, UpdateExerciseRequestSchema, UpdateExerciseResponseSchema, GetExercisesResponseSchema
...
logger = get_logger("EXERCISES_LOGGER")
...
@allure.step("Check assert_exercise")
def assert_exercise(actual: ExerciseSchema, expected: ExerciseSchema):
    ...
    :raises AssertionError: Если хотя бы одно поле не совпадает.
    """
    logger.info("Check assert_exercise")
